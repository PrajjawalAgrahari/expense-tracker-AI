import { testimonialsData } from "@/app/lib/landing-data"
            ...
            <Card key={index} className="p-10 px-11 flex-1">
                <CardContent className="flex flex-col gap-[22px]">
                    <div className="flex gap-4 items-center">
                         <Image height={40} width={40} src={testimonial.image} alt={`profile pic of ${testimonial.image}`} className="h-10 w-10 rounded-full"></Image>
                        <div>
